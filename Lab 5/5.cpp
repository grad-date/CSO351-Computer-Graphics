...
float ptsIni[8][3] = {{40, 40, -50}, {90, 40, -50}, {90, 90, -50}, {40, 90, -50}, {30, 30, 0}, {80, 30, 0}, {80, 80, 0}, {30, 80, 0}};
...
int main(int argc, char **argv)
{
    ...
    case 2:
        ...
        break;
    case 3:
        printf("Rotation about line:\n\n");
        printf("1.Parallelto X-axis.(y=B & z=C)\n");
        printf("2.Parallel to Y-axis.(x=A & z=C)\n");
        printf("3.Parallel toZ-axis.(x=A & y=B)\n");
